...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact-us" className="py-24 px-6 bg-surfaceAlt/50 relative overflow-hidden border-t border-secondary/5">
      {/* Background Decor */}
      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-16 md:gap-24 relative z-10">
        ...
        <div className="flex flex-col justify-center">
            ...
            <h2 className="text-4xl md:text-6xl font-display font-bold text-primary mb-8 leading-[1.1]">
        ...
        {/* Contact Form */}
        <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-secondary/5 border border-secondary/10 relative overflow-hidden">
            {status === 'success' ? (
